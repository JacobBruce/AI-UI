...
default_model_files = {
    '2DFAN-4': '2DFAN4-cd938726ad.pt',
    '3DFAN-4': '3DFAN4-4a694010b9.pt',
    'depth': 'depth-6c4283c0e0.pt',
	's3fd': 's3fd-619a316812.pth'
}
new_model_files = {
    '2DFAN-4': '2DFAN4-cd938726ad.pth',
    '3DFAN-4': '3DFAN4-4a694010b9.pth',
    'depth': 'depth-6c4283c0e0.pth'
}


class FaceAlignment:
    def __init__(self, ckpt_dir='./examples/ckpt/', landmarks_type=LandmarksType._3D, network_size=NetworkSize.LARGE,
        ...
        face_detector_kwargs = face_detector_kwargs or {"path_to_detector":ckpt_dir+default_model_files['s3fd']}
        self.face_detector = SFDDetector(device=device, verbose=verbose, **face_detector_kwargs)
        ...
        fan_weights = torch.load(ckpt_dir+default_model_files[network_name])
        ...
        if landmarks_type == LandmarksType._3D:
            ...
            depth_weights = torch.load(ckpt_dir+default_model_files['depth'])
            self.depth_prediciton_net.load_state_dict(depth_weights)
